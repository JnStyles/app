<template>
  <div class="getInfo">
    ...
    <group>
      ...
      <cell v-if="info.all_get_type" title="领取方式" :value="info.all_get_type==0?'未领取':info.all_get_type==1?'邮递':info.all_get_type==2?'话费充值':info.all_get_type==3?'兑换6豆':''"></cell>
      ...
      <cell v-if="info.change" title="兑换6豆金额" :value="info.change"></cell>
