    ...
    <div v-transfer-dom>
      <popup v-model="showBuy" height="264px" is-transparent>
        ...
        <div style="background-color:#fff;height:210px;margin:0 auto;padding-top:10px;">
          <group class="g_box">
            <x-number v-model="buyNum" :fillable="true" :min="0" :max="Number(info.surplus_price)"
                      :step="info.participation_number" width="7rem"></x-number>
            <div class="numBox">
              <checker v-model="buyNum" default-item-class="demo1-item" selected-item-class="demo1-item-selected">
                <checker-item :value="Number(info.participation_number*1)">{{info.participation_number*1}}
                </checker-item>
                <checker-item :value="Number(info.participation_number*2)">{{info.participation_number*2}}
                </checker-item>
                <checker-item :value="Number(info.participation_number*3)">{{info.participation_number*3}}
                </checker-item>
